  ...
  - [1.1. Property `Parsed document metadata > parameters > PARSER`](#parameters_PARSER)
    ...
    - [1.1.12. Property `Parsed document metadata > parameters > PARSER > metadata_fields`](#parameters_PARSER_metadata_fields)
      - [1.1.12.1. Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items](#parameters_PARSER_metadata_fields_items)
        - [1.1.12.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0`](#parameters_PARSER_metadata_fields_items_allOf_i0)
          - [1.1.12.1.1.1. If (name = "csv_metadata_file_properties")](#autogenerated_heading_2)
            - [1.1.12.1.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value`](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value)
              - [1.1.12.1.1.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > name`](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_name)
              - [1.1.12.1.1.1.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > hash`](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_hash)
              - [1.1.12.1.1.1.1.3. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents`](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_fullLineContents)
                - [1.1.12.1.1.1.1.3.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents > additionalProperties`](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_fullLineContents_additionalProperties)
        - [1.1.12.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 1`](#parameters_PARSER_metadata_fields_items_allOf_i1)
          - [1.1.12.1.2.1. If (name = "title")](#autogenerated_heading_3)
            - [1.1.12.1.2.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 1 > then > value`](#parameters_PARSER_metadata_fields_items_allOf_i1_then_value)
        - [1.1.12.1.3. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 2`](#parameters_PARSER_metadata_fields_items_allOf_i2)
          - [1.1.12.1.3.1. If (name = "headnote")](#autogenerated_heading_4)
            - [1.1.12.1.3.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 2 > then > value`](#parameters_PARSER_metadata_fields_items_allOf_i2_then_value)
        - [1.1.12.1.4. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3`](#parameters_PARSER_metadata_fields_items_allOf_i3)
          - [1.1.12.1.4.1. If (name = "category")](#autogenerated_heading_5)
            - [1.1.12.1.4.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value`](#parameters_PARSER_metadata_fields_items_allOf_i3_then_value)
              - [1.1.12.1.4.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value > name`](#parameters_PARSER_metadata_fields_items_allOf_i3_then_value_name)
              - [1.1.12.1.4.1.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value > parent`](#parameters_PARSER_metadata_fields_items_allOf_i3_then_value_parent)
        - [1.1.12.1.5. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > id`](#parameters_PARSER_metadata_fields_items_id)
        - [1.1.12.1.6. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > name`](#parameters_PARSER_metadata_fields_items_name)
        - [1.1.12.1.7. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > value`](#parameters_PARSER_metadata_fields_items_value)
        - [1.1.12.1.8. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > source`](#parameters_PARSER_metadata_fields_items_source)
        - [1.1.12.1.9. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > timestamp`](#parameters_PARSER_metadata_fields_items_timestamp)
...
| All of(Requirement)                                         |
| ----------------------------------------------------------- |
| [item 0](#parameters_PARSER_metadata_fields_items_allOf_i0) |
| [item 1](#parameters_PARSER_metadata_fields_items_allOf_i1) |
| [item 2](#parameters_PARSER_metadata_fields_items_allOf_i2) |
| [item 3](#parameters_PARSER_metadata_fields_items_allOf_i3) |

###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0"></a>1.1.12.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0`
...
###### <a name="autogenerated_heading_2"></a>1.1.12.1.1.1. If (name = "csv_metadata_file_properties")
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0_then_value"></a>1.1.12.1.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value`
...
| Property                                                                                             | Pattern | Type   | Deprecated | Definition | Title/Description      |
| ---------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ---------------------- |
| + [name](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_name )                         | No      | string | No         | -          | Metadata file name     |
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0_then_value_name"></a>1.1.12.1.1.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > name`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0_then_value_hash"></a>1.1.12.1.1.1.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > hash`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0_then_value_fullLineContents"></a>1.1.12.1.1.1.1.3. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents`
...
| **Type**                  | `object`                                                                                                                                                  |
| **Required**              | Yes                                                                                                                                                       |
| **Additional properties** | [Each additional property must conform to the schema](#parameters_PARSER_metadata_fields_items_allOf_i0_then_value_fullLineContents_additionalProperties) |
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i0_then_value_fullLineContents_additionalProperties"></a>1.1.12.1.1.1.1.3.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents > additionalProperties`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i1"></a>1.1.12.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 1`
...
###### <a name="autogenerated_heading_3"></a>1.1.12.1.2.1. If (name = "title")
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i1_then_value"></a>1.1.12.1.2.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 1 > then > value`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i2"></a>1.1.12.1.3. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 2`
...
###### <a name="autogenerated_heading_4"></a>1.1.12.1.3.1. If (name = "headnote")
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i2_then_value"></a>1.1.12.1.3.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 2 > then > value`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i3"></a>1.1.12.1.4. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3`
...
###### <a name="autogenerated_heading_5"></a>1.1.12.1.4.1. If (name = "category")
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i3_then_value"></a>1.1.12.1.4.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i3_then_value_name"></a>1.1.12.1.4.1.1.1. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value > name`
...
###### <a name="parameters_PARSER_metadata_fields_items_allOf_i3_then_value_parent"></a>1.1.12.1.4.1.1.2. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > allOf > item 3 > then > value > parent`
...
###### <a name="parameters_PARSER_metadata_fields_items_id"></a>1.1.12.1.5. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > id`
...
###### <a name="parameters_PARSER_metadata_fields_items_name"></a>1.1.12.1.6. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > name`
...
###### <a name="parameters_PARSER_metadata_fields_items_value"></a>1.1.12.1.7. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > value`
...
###### <a name="parameters_PARSER_metadata_fields_items_source"></a>1.1.12.1.8. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > source`
...
###### <a name="parameters_PARSER_metadata_fields_items_timestamp"></a>1.1.12.1.9. Property `Parsed document metadata > parameters > PARSER > metadata_fields > metadata_fields items > timestamp`
