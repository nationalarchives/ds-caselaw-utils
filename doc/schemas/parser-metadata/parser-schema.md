...
- [12. Property `Parser process metadata > metadata_fields`](#metadata_fields)
  - [12.1. Parser process metadata > metadata_fields > metadata_fields items](#metadata_fields_items)
    - [12.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0`](#metadata_fields_items_allOf_i0)
      - [12.1.1.1. If (name = "csv_metadata_file_properties")](#autogenerated_heading_2)
        - [12.1.1.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value`](#metadata_fields_items_allOf_i0_then_value)
          - [12.1.1.1.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > name`](#metadata_fields_items_allOf_i0_then_value_name)
          - [12.1.1.1.1.2. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > hash`](#metadata_fields_items_allOf_i0_then_value_hash)
          - [12.1.1.1.1.3. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents`](#metadata_fields_items_allOf_i0_then_value_fullLineContents)
            - [12.1.1.1.1.3.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents > additionalProperties`](#metadata_fields_items_allOf_i0_then_value_fullLineContents_additionalProperties)
    - [12.1.2. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 1`](#metadata_fields_items_allOf_i1)
      - [12.1.2.1. If (name = "title")](#autogenerated_heading_3)
    ...
    - [12.1.3. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 2`](#metadata_fields_items_allOf_i2)
      - [12.1.3.1. If (name = "headnote")](#autogenerated_heading_4)
    ...
    - [12.1.4. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3`](#metadata_fields_items_allOf_i3)
      - [12.1.4.1. If (name = "category")](#autogenerated_heading_5)
        - [12.1.4.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value`](#metadata_fields_items_allOf_i3_then_value)
          - [12.1.4.1.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value > name`](#metadata_fields_items_allOf_i3_then_value_name)
          - [12.1.4.1.1.2. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value > parent`](#metadata_fields_items_allOf_i3_then_value_parent)
    - [12.1.5. Property `Parser process metadata > metadata_fields > metadata_fields items > id`](#metadata_fields_items_id)
    - [12.1.6. Property `Parser process metadata > metadata_fields > metadata_fields items > name`](#metadata_fields_items_name)
    - [12.1.7. Property `Parser process metadata > metadata_fields > metadata_fields items > value`](#metadata_fields_items_value)
    - [12.1.8. Property `Parser process metadata > metadata_fields > metadata_fields items > source`](#metadata_fields_items_source)
    - [12.1.9. Property `Parser process metadata > metadata_fields > metadata_fields items > timestamp`](#metadata_fields_items_timestamp)
...
##### <a name="autogenerated_heading_2"></a>12.1.1.1. If (name = "csv_metadata_file_properties")
...
###### <a name="metadata_fields_items_allOf_i0_then_value_name"></a>12.1.1.1.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > name`
...
###### <a name="metadata_fields_items_allOf_i0_then_value_hash"></a>12.1.1.1.1.2. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > hash`
...
###### <a name="metadata_fields_items_allOf_i0_then_value_fullLineContents"></a>12.1.1.1.1.3. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents`
...
###### <a name="metadata_fields_items_allOf_i0_then_value_fullLineContents_additionalProperties"></a>12.1.1.1.1.3.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 0 > then > value > fullLineContents > additionalProperties`
...
##### <a name="autogenerated_heading_3"></a>12.1.2.1. If (name = "title")
...
##### <a name="autogenerated_heading_4"></a>12.1.3.1. If (name = "headnote")
...
#### <a name="metadata_fields_items_allOf_i3"></a>12.1.4. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3`
...
##### <a name="autogenerated_heading_5"></a>12.1.4.1. If (name = "category")
...
###### <a name="metadata_fields_items_allOf_i3_then_value"></a>12.1.4.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value`
...
###### <a name="metadata_fields_items_allOf_i3_then_value_name"></a>12.1.4.1.1.1. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value > name`
...
###### <a name="metadata_fields_items_allOf_i3_then_value_parent"></a>12.1.4.1.1.2. Property `Parser process metadata > metadata_fields > metadata_fields items > allOf > item 3 > then > value > parent`
...
#### <a name="metadata_fields_items_id"></a>12.1.5. Property `Parser process metadata > metadata_fields > metadata_fields items > id`
...
#### <a name="metadata_fields_items_name"></a>12.1.6. Property `Parser process metadata > metadata_fields > metadata_fields items > name`
...
#### <a name="metadata_fields_items_value"></a>12.1.7. Property `Parser process metadata > metadata_fields > metadata_fields items > value`
...
#### <a name="metadata_fields_items_source"></a>12.1.8. Property `Parser process metadata > metadata_fields > metadata_fields items > source`
...
#### <a name="metadata_fields_items_timestamp"></a>12.1.9. Property `Parser process metadata > metadata_fields > metadata_fields items > timestamp`
